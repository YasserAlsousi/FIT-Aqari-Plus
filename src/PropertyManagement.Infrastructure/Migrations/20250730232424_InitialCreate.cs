        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AssignedToPhone = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MaintenanceImage_MaintenanceRequests_MaintenanceRequestId",
            ...
            migrationBuilder.InsertData(
                table: "Owners",
                columns: new[] { "Id", "Address", "CreatedAt", "Email", "FirstName", "LastName", "NationalId", "Phone", "UpdatedAt" },
                values: new object[] { 1, "القاهرة، مصر", new DateTime(2025, 7, 30, 23, 24, 22, 101, DateTimeKind.Utc).AddTicks(2704), "ahmed.mohamed@example.com", "أحمد", "محمد", "12345678901234", "+201234567890", null });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MaintenanceImage_MaintenanceRequestId",
